...
class MyopicPlanning_2D:
    ...
    def find_next_waypoint(self):
        ...
        for k in range(len(id)):
            ...
            eibv.append(get_eibv_1d(self.knowledge.threshold, self.knowledge.mu,
    ...
    def find_candidates_loc(self):
        ...
        delta_z = self.knowledge.coordinates[:, 2] - self.knowledge.coordinates[
            self.knowledge.ind_now, 2]  # depth distance in z-direction
    ...
    def search_for_new_location(self):
        ind_next = np.abs(get_excursion_prob_1d(self.knowledge.mu, self.knowledge.Sigma,
